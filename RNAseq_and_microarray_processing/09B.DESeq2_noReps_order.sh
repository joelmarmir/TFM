...
#SBATCH --output=/users/genomics/jmartinez/Deseq2_8_log.out
...
process_phenodata_file() {
    ...
    Rscript /users/genomics/jmartinez/scripts/differential_expression_analysis_v11_noReps.r "$phenodata_file" "$study_counts_dir" "$output_file"
}
